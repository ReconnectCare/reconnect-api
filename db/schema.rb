...
ActiveRecord::Schema.define(version: 2021_07_13_183243) do
  ...
  create_table "conference_numbers", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["discarded_at"], name: "index_conference_numbers_on_discarded_at"
  end
  ...
  create_table "voice_calls", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "reason", default: "call_started", null: false
